<footer aria-label="Site Footer" class="bg-neutral-800 bottom-0 w-full border-t border-orange-300">
  <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-400">
      Bienvenido a la mejor plataforma de conciertos del sector.
    </p>

    <nav aria-label="Footer Nav" class="mt-12">
      <ul class="flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
        <li>
          <a class="transition text-gray-400 hover:text-orange-500" href="/conciertos">Conciertos</a>
        </li>

        <li>
          <a class="transition text-gray-400 hover:text-orange-500" href="/artistas">Artistas</a>
        </li>

        <li>
          <a class="transition text-gray-400 hover:text-orange-500" href="/login">Iniciar Sesión</a>
        </li>

        <li>
          <a class="transition text-gray-400 hover:text-orange-500" href="/register">Registro</a>
        </li>
        ...
        <a href="https://www.facebook.com/amazongames/" rel="noreferrer" target="_blank" class="transition text-gray-400 hover:text-orange-300">
          ...
          <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89
              3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
          </svg>
        </a>
      </li>
        ...
        <a
          ...
          <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path fill-rule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153
              ...
              1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643
              ...
              1.857.182.466.399.8.748 1.15.35.35.683.566 1.15.748.353.137.882.3 1.857.344 1.054.048 1.37.058
              4.041.058h.08c2.597 0 2.917-.01 3.96-.058.976-.045 1.505-.207 1.858-.344.466-.182.8-.398 
        ...
        <a href="https://github.com/DabBlack" rel="noreferrer" target="_blank" class="transition text-gray-400 hover:text-orange-300">
          ...
          <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path fill-rule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 
              ...
              1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0
              3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019
